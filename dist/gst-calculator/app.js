// GST Inclusive/Exclusive Calculator - calculation logic reused verbatim
// from the original InfoBridgeIndia tool (js/gst-calculator.js). Only the
...
function resetCalculator() {
  ...
  document.querySelector('input[name="transactionType"][value="same"]').checked = true;
